...
const RIGHTS_NO_RIGHTS = rights.RIGHTS_FOLDER_VISIBLE;

const RIGHTS_CONTRIBUTOR = rights.RIGHTS_FOLDER_VISIBLE | rights.RIGHTS_CREATE;

const RIGHTS_READONLY = rights.RIGHTS_NO_RIGHTS | rights.RIGHTS_READ_ANY;

const RIGHTS_REVIEWER = rights.RIGHTS_READ_ANY | rights.RIGHTS_FOLDER_VISIBLE;

const RIGHTS_NONEDITINGAUTHOR = rights.RIGHTS_REVIEWER | rights.RIGHTS_CREATE | rights.RIGHTS_DELETE_OWNED;

const RIGHTS_AUTHOR = rights.RIGHTS_NONEDITINGAUTHOR | rights.RIGHTS_EDIT_OWNED;

const RIGHTS_PUBLISHINGAUTHOR	= rights.RIGHTS_AUTHOR | rights.RIGHTS_CREATE_SUBFOLDER;

const RIGHTS_EDITOR	= rights.RIGHTS_AUTHOR | rights.RIGHTS_DELETE_ANY | rights.RIGHTS_EDIT_ANY;

const RIGHTS_PUBLISHINGEDITOR	= rights.RIGHTS_EDITOR | rights.RIGHTS_CREATE_SUBFOLDER;

const RIGHTS_SECRETARY = rights.RIGHTS_READONLY |
...
const RIGHTS_FULL_CONTROL	= rights.RIGHTS_SECRETARY |
rights.RIGHTS_CREATE_SUBFOLDER;

const RIGHTS_OWNER = rights.RIGHTS_PUBLISHINGEDITOR |
...
const RIGHTS_CAL_NONEDITINGAUTHOR	= rights.RIGHTS_REVIEWER |
rights.RIGHTS_FBSIMPLE |
												rights.RIGHTS_FBDETAILED |
												rights.RIGHTS_CREATE |
												rights.RIGHTS_DELETE_OWNED;

const RIGHTS_CAL_AUTHOR		= rights.RIGHTS_NONEDITINGAUTHOR |
rights.RIGHTS_FBSIMPLE |
rights.RIGHTS_FBDETAILED |
rights.RIGHTS_EDIT_OWNED;

const RIGHTS_CAL_PUBLISHINGAUTHOR	= rights.RIGHTS_AUTHOR |
rights.RIGHTS_FBSIMPLE |
rights.RIGHTS_FBDETAILED |
rights.RIGHTS_CREATE_SUBFOLDER;

const RIGHTS_CAL_EDITOR		= rights.RIGHTS_AUTHOR |
rights.RIGHTS_FBSIMPLE |
rights.RIGHTS_FBDETAILED |
rights.RIGHTS_DELETE_ANY |
rights.RIGHTS_EDIT_ANY;

const RIGHTS_CAL_PUBLISHINGEDITOR	= rights.RIGHTS_EDITOR |
rights.RIGHTS_FBSIMPLE |
rights.RIGHTS_FBDETAILED |
rights.RIGHTS_CREATE_SUBFOLDER;

const RIGHTS_CAL_OWNER		= rights.RIGHTS_PUBLISHINGEDITOR |
rights.RIGHTS_CREATE_FOLDER |
rights.RIGHTS_FBSIMPLE |
rights.RIGHTS_FBDETAILED |
rights.RIGHTS_FOLDER_CONTACT;
